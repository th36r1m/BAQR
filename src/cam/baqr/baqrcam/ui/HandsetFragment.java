...
import com.baqr.baqrcam.Utilities;
...
public class HandsetFragment extends Fragment {
    ...
    public HandsetFragment (Context ctx) {
    	context = ctx;
    }    
    
	@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    	View rootView = inflater.inflate(R.layout.baqrcam_main,container,false);
        ...
        mPulseAnimation = AnimationUtils.loadAnimation(context, R.anim.pulse);
    ...
    public void onStart() {
        ...
        try {
			mVersion.setText("v"+context.getPackageManager().getPackageInfo(context.getPackageName(), 0 ).versionName);
		} catch (Exception e) {
			mVersion.setText("v???");
		}
