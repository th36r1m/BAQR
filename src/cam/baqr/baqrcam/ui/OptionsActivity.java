...
import static com.baqr.http.TinyHttpServer.KEY_HTTP_ENABLED;
import static com.baqr.http.TinyHttpServer.KEY_HTTP_PORT;
...
public class OptionsActivity extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		addPreferencesFromResource(R.xml.baqrcam_preferences);
		...
		videoEncoder.setValue(String.valueOf(BaqrcamActivity.videoEncoder));
		audioEncoder.setValue(String.valueOf(BaqrcamActivity.audioEncoder));
		videoFramerate.setValue(String.valueOf(BaqrcamActivity.videoQuality.framerate));
		videoBitrate.setValue(String.valueOf(BaqrcamActivity.videoQuality.bitrate/1000));
		videoResolution.setValue(BaqrcamActivity.videoQuality.resX+"x"+BaqrcamActivity.videoQuality.resY);
